...
import br.com.victormattos.gestao_vagas.modules.company.dto.AuthCompanyResponseDTO;
...
public class AuthCompanyUseCase {
  ...
  public AuthCompanyResponseDTO execute(AuthCompanyDTO authCompanyDTO) throws AuthenticationException {
    ...
    var token = JWT.create().withIssuer("javagas")
        ...
        .sign(algorithm);
    var authCompanyResponseDTO = new AuthCompanyResponseDTO(token.toString(), expiresIn.toEpochMilli());
